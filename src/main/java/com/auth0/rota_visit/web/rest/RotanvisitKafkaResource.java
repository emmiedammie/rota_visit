...
@RestController
@RequestMapping("/api/rotanvisit-kafka")
public class RotanvisitKafkaResource {

    private final Logger log = LoggerFactory.getLogger(RotanvisitKafkaResource.class);
    ...
    public RotanvisitKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
